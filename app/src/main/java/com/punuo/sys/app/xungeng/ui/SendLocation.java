...
import com.punuo.sys.app.xungeng.adapter.PoiAdapter;
import com.punuo.sys.app.xungeng.model.MyPoiItem;
...
public class SendLocation extends MyActivity implements LocationSource, AMapLocationListener, GeocodeSearch.OnGeocodeSearchListener,View.OnClickListener {
    @Bind(R.id.mapview)
    MapView mapview;
    @Bind(R.id.poiloc)
    ListView poiloc;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        poiloc.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                LogUtil.d("111", myPoiItems.get(position).getPoiItem().getSnippet());
    ...
    public void onRegeocodeSearched(RegeocodeResult regeocodeResult, int i) {
        ...
        LogUtil.e("1111", address.getFormatAddress());
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.send:
                if (lastposition!=-1) {
                    LogUtil.d("111", myPoiItems.get(lastposition).getPoiItem().getSnippet());
                }
